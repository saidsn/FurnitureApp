...
const Navbar = ({ open, setOpen }) => {
  ...
  return (
    <div className="container">
      <nav className={`navbar ${open ? "responsive__navbar" : ""}`}>
        <ul className="navbar__list">
          <li className="navbar__list--item" onClick={() => setOpen(false)}>
