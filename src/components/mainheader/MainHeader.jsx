          ...
          <div className="main-header">
            <div className="main-header__left">
              <h1 className="main-header__left--title">
                {language === "az" ? mainHeader.titleAz : language === "ru" ? mainHeader.titleRu : mainHeader.title}
              </h1>
              <p className="main-header__left--description">
                {language === "az" ? mainHeader.descriptionAz : language === "ru" ? mainHeader.descriptionRu : mainHeader.description}
              </p>
              <Link to="/products">
                <MainButton>
                  <svg
